...
namespace StudentResultManagement
{
    public class ClsVar
    {
        ...
        public static string vrsn;
        public static string logDescription;
        public static string ShowExOTinDptPwd = "";
        public static string GblCountFrom;
        public static string GblCountTo;
        public static Int32  GblCountDays;

        public static string GblRmsPath;
        ...
        public static string gblVirsion;
        ...
        public static string GblDop;
        public static string GblTimeCardExportedTillDate;
        public static string GblFormulaFld1;
        public static string GblFormulaFld2;
        public static string GblFormulaFld3;
        public static string gblDrv;
        public static Boolean SaveProject;
        public static Boolean DelProject;
        public static Boolean VwProject;

        public static Boolean SaveBonus;
        public static Boolean DelBonus;
        public static Boolean VwBonus;

        public static Boolean SaveMaternity;
        public static Boolean DelMaternity;
        public static Boolean VwMaternity;

        public static Boolean SaveEmpBangla;
        public static Boolean DelEmpBangla;
        public static Boolean VwEmpBangla;

        public static Boolean VwHrReport;
        public static Boolean VwMaster;
    ...
    public static Boolean Sewing;
        public static Int32 salSheetLock;
